...
+---------------------------------------------------------------------------
|   > $Date: 2006-11-13 15:22:45 -0600 (Mon, 13 Nov 2006) $
|   > $Revision: 726 $
|   > $Author: bfarber $
+---------------------------------------------------------------------------
|
...
require_once ROOT_PATH   . "sources/classes/class_morg.php";
...
$ipsclass->morg	            =  new morgenshtern();
$ipsclass->morg->ipsclass =& $ipsclass;

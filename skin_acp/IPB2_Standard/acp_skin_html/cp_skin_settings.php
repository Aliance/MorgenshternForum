...
<div class='tableborder'>
 <div class='tableheaderalt'>Отчет сравнения XML файла с записями в БД</div>
 <table width='100%' cellpadding='0' cellspacing='0'>
 <tr>
	<td width='50%' valign='top' class='tablerow2'>
		<div class='tablesubheader'>Настройки не находятся в БД</div>
...
$IPBHTML .= <<<EOF
	...
	<td width='50%' valign='top' class='tablerow2'>
	<div class='tablesubheader'>Настройки не находятся в XML файле</div>
	<table width='100%' cellpadding='4' cellspacing='0'>
EOF;

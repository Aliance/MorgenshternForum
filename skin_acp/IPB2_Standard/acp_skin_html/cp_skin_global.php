...
<div id='loading-layer' style='display:none'>
	<div id='loading-layer-shadow'>
	   <div id='loading-layer-inner' >
		   <img src='{$this->ipsclass->skin_acp_url}/images/loading_anim.gif' style='vertical-align:middle' border='0' alt='Загрузка...' /><br />
		   <span style='font-weight:bold' id='loading-layer-text'>Загрузка данных...</span>
	   </div>
	</div>
</div>
...
<div class='information-box'>
 <img src='{$this->ipsclass->skin_acp_url}/images/icon_information.png' alt='информация' />
 <h2>$title</h2>
 <p>
 	<br />
 	$content
...
<div class='warning-box'>
 <img src='{$this->ipsclass->skin_acp_url}/images/icon_warning.png' alt='информация' />
 <h2>$title</h2>
 <p>
 	<br />
 	$content
...
<div class='global-memberbar'>
 Здравствуйте, <strong>{$this->ipsclass->member['members_display_name']}</strong> [
 <a href='{$this->ipsclass->vars['board_url']}/index.php' style='text-decoration: underline' target='_blank'>на форум</a> &middot;
 <a href='{$this->ipsclass->base_url}&amp;act=login&amp;code=login-out' style='text-decoration: underline'>выход</a>
 ]
</div>
EOF;
...
$IPBHTML .= <<<EOF
<div class='information-box'>
 <img src='{$this->ipsclass->skin_acp_url}/images/global-infoicon.gif' alt='информация' />
 <h2>Сообщение Invision Power Board</h2>
 <p>
 	<br />
...
<%TABS%>
<div class='logoright'><img src='{$this->ipsclass->skin_acp_url}/images/acp-logo.gif' alt='IPDynamic' border='0' /></div>
</div>
<!-- / TOP TABS -->
...
<td colspan='2'>
 ...
 <a href='http://www.ibresource.ru/'>Русская версия</a>
  <a href='http://www.invisionpower.com'>IP.Board</a> &copy;
EOF;
...
$IPBHTML .= <<<EOF
<div class='{$onoff['content']}'><img src='{$this->ipsclass->skin_acp_url}/images/tabs_main/system.png' style='vertical-align:middle' /> <a href='{$this->ipsclass->base_url}&section=content'>УПРАВЛЕНИЕ</a></div>
<div class='{$onoff['lookandfeel']}'><img src='{$this->ipsclass->skin_acp_url}/images/tabs_main/lookfeel.png' style='vertical-align:middle' /> <a href='{$this->ipsclass->base_url}&section=lookandfeel'>ВНЕШНИЙ ВИД</a></div>
<div class='{$onoff['tools']}'><img src='{$this->ipsclass->skin_acp_url}/images/tabs_main/tools.png' style='vertical-align:middle' /> <a href='{$this->ipsclass->base_url}&section=tools'>НАСТРОЙКИ</a></div>
<div class='{$onoff['components']}'><img src='{$this->ipsclass->skin_acp_url}/images/tabs_main/components.png' style='vertical-align:middle' /> <a href='{$this->ipsclass->base_url}&section=components'>КОМПОНЕНТЫ</a></div>
<div class='{$onoff['admin']}'><img src='{$this->ipsclass->skin_acp_url}/images/tabs_main/admin.png' style='vertical-align:middle' /> <a href='{$this->ipsclass->base_url}&section=admin'>ПРОЧЕЕ</a></div>
<div class='{$onoff['help']}'><img src='{$this->ipsclass->skin_acp_url}/images/tabs_main/help.png' style='vertical-align:middle' /> <a href='{$this->ipsclass->base_url}&section=help'>ПОДДЕРЖКА</a></div>
...
<div class='tableborder' style='vertical-align:bottom;text-align:left;width:75%;color:#555'>
 <div style='padding:5px'><b>Использованы запросы:</b></div>
...
<tr>
 ...
 <input type='hidden' name='qstring' value='$query_string' />
  ...
  <tr>
   ...
   <div align='center'><strong>Добро пожаловать в&nbsp;IP.Board</strong></div>
   <br />
  	<div style='font-size:9px;color:gray'>&copy; Invision Power Services, Inc.
	<br />Эта программа защищена в соответствии с международными законами об авторском праве.</div>
   </div>
   </td>
...
{
$IPBHTML .= <<<EOF
		<td align='right'><strong>Имя пользователя</strong></td>
EOF;
}
else
{
...
$IPBHTML .= <<<EOF
	 ...
	 <tr>
	  <td colspan='2' align='center'><input type='submit' style='border:1px solid #AAA' value='Войти' /></td>
	 </tr>
	 <tr>
	  <td colspan='2'><br />
...
<div class='tableborder'>
 <div class='alttitle'>
  ...
  <div style='padding-left:3px;padding-top:14px;font-size:16px;'>Переадресация....</div>
 </div>
 <div style='background-color:#FFF;padding:10px;'>
 <strong>{$text}</strong>
 <br />
 <br />
 <a href='$url'>( нажмите сюда, если не хотите ждать )</a>
 </div>
</div>
</div>
EOF;
...
<div class='tableborder'>
 <div class='alttitle'>
  <div style='float:right'><img src='{$this->ipsclass->skin_acp_url}/images/acp_logo.gif' alt='IPB' border='0' /></div>
  <div style='padding-left:3px;padding-top:14px;font-size:16px;'>Операция завершена</div>
 </div>
 <div style='background-color:#FFF;padding:10px;'>
 <strong>{$text}</strong>
 </div>
...
<tr>
 ...
 <div>
  ...
  <tr>
   ...
   <br />
   <div class='desctext' style='font-size:10px'>
   <div align='center'><strong>Переадресация...</strong></div>
   <br />
  	<div style='font-size:9px;color:gray'>Сейчас вы будете автоматически переадресованы.</div>
   </div>
   </td>
   <td width='300' style='width:300px' valign='top'>
	 <table width='100%' cellpadding='5' cellspacing='0' border='0'>
...
$IPBHTML .= <<<EOF
<br />
 <div align='right' id='jwrap'><strong>Быстрый переход</strong> <!--JUMP--></div>
...
<div id='loading-layer' style='display:none'>
	<div id='loading-layer-shadow'>
	   <div id='loading-layer-inner' >
		   <img src='{$this->ipsclass->skin_acp_url}/images/loading_anim.gif' style='vertical-align:middle' border='0' alt='Загрузка...' />
		   <span style='font-weight:bold' id='loading-layer-text'>Загрузка данных...</span>
	   </div>
	</div>
</div>
...
menu_build_menu(
	pgjmp.id,
	"<div onmouseover='pages_st_focus("+ipb_pages_shown+")' align='center'>{$this->ipsclass->lang['global_page_jump']}</div><input type='text' size='5' name='st' id='st-"+ipb_pages_shown+"' /> <input type='button' class='button' onclick='do_multi_page_jump("+ipb_pages_shown+");' value='{$this->ipsclass->lang['jmp_go']}' />",
	1 );
...
$IPBHTML .= <<<EOF
&nbsp;<span class="pagelink"><a href="$url" title="Далее">&gt;</a></span>
EOF;
...
$IPBHTML .= <<<EOF
<span class="pagelink"><a href="$url" title="Предпросмотр">&lt;</a></span>
EOF;

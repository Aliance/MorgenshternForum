...
<div class='tableborder'>
 <div class='tablesubheader'>Installing New Payment Gateways</div>
 <div class='tablerow2' style='padding:6px;'>
  To install a new payment gateway module, simply upload the file 'class_gw_{name}.php' into '/sources/classes/paymentgateways' and then
  click on the 'install' link. Modules showing as 'installed' are active and can be set up from within the 'Manage Payment Gateways' link.
 </div>
</div>
<br />
<div class='tableborder'>

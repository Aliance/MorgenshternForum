...
class ipsclass {
	...
	*/
	...
	function init_db_connection( $db, $user, $pass, $host, $pre, $cp, $driver='mysql' )
	{
		//-----------------------------------------
		// INIT
		//-----------------------------------------
...
//        echo $destination_cset; exit;
        ...
        {
            require_once( INS_KERNEL_PATH.'/class_convert_charset.php' );

...
class install_extra
{
	...
	{
		$extra = "<tr>
					<td class='title'><b>Кодировка MySQL</b><div style='color:gray; font-weight:normal;'>Не изменяйте, если не уверены.</div></td>
					<td class='content'><input type='text' name='mysql_codepage' class='sql_form' value='cp1251'></td>
				  </tr>
                  <tr>
					<td class='title'><b>Тип MySQL таблиц</b><div style='color:gray; font-weight:normal;'>Не изменяйте, если не уверены.</div></td>

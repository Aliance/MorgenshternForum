...
function write_rte_html()
{
	...
	format_select += '	<option value="<p>">Параграф</option>';
	format_select += '	<option value="<h1>">Заголовок 1 <h1></option>';
	format_select += '	<option value="<h2>">Заголовок 2 <h2></option>';
	format_select += '	<option value="<h3>">Заголовок 3 <h3></option>';
	format_select += '	<option value="<h4>">Заголовок 4 <h4></option>';
	format_select += '	<option value="<h5>">Заголовок 5 <h5></option>';
	format_select += '	<option value="<h6>">Заголовок 6 <h6></option>';
	format_select += '	<option value="<address>">Адрес <ADDR></option>';
	format_select += '	<option value="<pre>">Форматирование <pre></option>';
	...
	button_quote       = '<td><div><img class="rteimage" src="' + g_imagesPath + 'quote.gif" width="21" height="21" alt="'+js_tt_quote+'" title="'+js_tt_quote+'" onClick="wrap_tags(\'[quote]\',\'[/quote]\')"></div></td>';
	button_code        = '<td><div><img class="rteimage" src="' + g_imagesPath + 'code.gif"  width="21" height="21" alt="'+js_tt_code+'" title="'+js_tt_code+'" onclick="wrap_tags(\'[code]\',\'[/code]\')"></div></td>';
	...
	if (isIE)
	{
		button_spell = '<td><div><img class="rteimage" src="' + g_imagesPath + 'spellcheck.gif" width="25" height="24" alt="Проверка орфографии" title="Проверка орфографии" onClick="checkspell()"></td>' + button_SEP;
	}
	else
	{
		button_spell = "";
	...
	bar_buttons_one  = '<table style="width:'+g_tablewidth+g_width_unit+'" class="rtebuttonbar1" cellpadding="2" cellspacing="0" id="Buttons1" width="' + g_tablewidth + '">';
	bar_buttons_one += "<tr>\n";
	...
	bar_buttons_two  = '<table style="width:'+g_tablewidth+g_width_unit+'" class="rtebuttonbar2" cellpadding="2" cellspacing="0" id="Buttons2" width="' + g_tablewidth + '">';
	bar_buttons_two += "<tr>\n";
	...
	document.writeln('<iframe class="rteiframe" frameborder="0" style="margin:0px;width:' + g_width + g_width_unit+';height:' + g_height + 'px" id="' + g_rte + '" name="' + g_rte + '" width="' + g_width + g_width_unit + '" height="' + g_height + 'px" src="' + g_includesPath + 'blank.html"></iframe>');
	//alert ('<iframe class="rteiframe" frameborder="0" style="margin:0px;width:' + g_width + g_width_unit+';height:' + g_height + 'px" id="' + g_rte + '" name="' + g_rte + '" width="' + g_width + g_width_unit + '" height="' + g_height + 'px" src="' + g_includesPath + 'blank.html"></iframe>');
	
	//-------------------------------
	// Bottom tabs
	//-------------------------------

	document.writeln('<table cellpadding="0" cellspacing="0" style="padding:0px;margin:0px;height:30px;width:'+ g_tablewidth+g_width_unit+'" width="' + g_tablewidth + '">');

...
class class_rss
{
	...
	*/
	function rss_create_document( )
	{
		...
		{
			$this->errors[] = "Íåò êàíàëîâ äëÿ RSS";
		}
	...
	*/
	function rss_format_image( $in=array() )
	{
		if ( ! $in['url'] )
		{
			$this->errors[] = "Íå âîçìîæíî äîáàâèòü èçîáðàæåíèå - íå äîñòàòî÷íî äàííûõ";
		}
	...
	*/
	function rss_parse_feed_from_url( $feed_location )
	{
		...
		{
			$this->errors[] = sprintf("Îøèáêà â XML: %s â ñòðîêå %d",  xml_error_string( xml_get_error_code($xml_parser) ), xml_get_current_line_number($xml_parser) );
		}

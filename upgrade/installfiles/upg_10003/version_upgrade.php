...
class version_upgrade
{
	...
	function step_10()
	{
		...
		{
			$this->install->message = "Все пользовательские e-mail проверены, переходим к инициализации converge-системы...";
	...
	function step_18()
	{
		...
		$this->install->message = "Вставка данных завершена, далее удаление старых таблиц...<br /><br />$this->sqlcount запросов выполнено....";
	...
	function step_19()
	{
		...
		$this->install->message = "Старые таблицы удалены, далее оптимизация...<br /><br />$this->sqlcount запросов выполнено....";

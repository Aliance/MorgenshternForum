...
class version_upgrade
{
	...
	function update_forums()
	{
		...
		$this->install->message = "Добавлены права на скачивание в форумах, переходим к обновлению HTML-логики в шаблонах...";
	...
	function update_template_bits()
	{
		...
		if ( ! $done )
		{
			$this->install->message = "Проверены шаблоны с $start по $end. Обновлено: $updated...";
			$this->install->saved_data['workact'] 	= 'update_template_bits';
		...
		{
			$this->install->message = "Шаблоны обновлены, переходим к удалению временных данных...";
	...
	function finish_up()
	{
		...
		$this->install->message = "Удаление временных данных мастера завершено,  переходим к созданию главного стиля IPB 2.2.0...";
	...
	function add_skin()
	{
		...
		$this->install->message = "Главный стиль IPB 2.2.0 создан...";

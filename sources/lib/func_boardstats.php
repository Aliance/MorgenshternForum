	...
	function show_calendar_events()
	{
		...
		if ($this->ipsclass->vars['show_calendar'])
		{
			...
			foreach( $events as $event )
			{
				...
				$c_time = '';
				$c_time_day = gmdate( 'd', $event['event_activetime'] );
                $c_time_month = $this->ipsclass->lang[ 'M_' . gmdate( 'n', $event['event_activetime'] ) ];
                $c_time_year = gmdate( 'Y', $event['event_activetime'] );
                
                $c_time = $c_time_day . ' ' . $c_time_month . ' ' . $c_time_year;

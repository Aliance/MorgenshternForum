...
class ad_chatsigma
{
	...
	function chat_splash()
	{
		...
		else
		{
			...
			$this->ipsclass->admin->page_detail = "Если вы уже купили AddOnChat, просто введите ваш Customer Account ID в поле ниже.";
			...
			$this->ipsclass->html .= "<form action='{$this->ipsclass->base_url}&{$this->ipsclass->form_code}&code=chatsave' method='POST'>
									  ...
									  <tr>
									   <td valign='middle' align='left'><b style='color:white'>Владеете AddOnChat?</b></td>
									   <td valign='middle' align='left'><input type='text' size=35 name='account_no' value='введите ваш Customer Account ID здесь...' onClick=\"this.value='';\"></td>
	...
	function chat_save()
	{
		...
		$fields = array( 'com_enabled'    => 1,
						 'com_menu_data'  => array( 0 => array( 'menu_text'    => 'Настройки чата',
	...
	function chat04_config()
	{
		...
		$this->ipsclass->admin->page_title  = "Настройка AddOnChat";

...
+---------------------------------------------------------------------------
|   > $Date: 2006-10-11 13:01:38 -0500 (Wed, 11 Oct 2006) $
|   > $Revision: 628 $
|   > $Author: bfarber $
+---------------------------------------------------------------------------
|
	...
	*/
	...
	function install_gateway()
	{
		...
		if ( is_array( $this->gateway->db_info ) )
		{
			$this->ipsclass->DB->do_insert( 'subscription_methods', array( 'submethod_title'         => $this->gateway->db_info['human_title'],
																		   ...
																		   'submethod_is_cc'         => $this->gateway->db_info['allow_creditcards'],
																		   'submethod_is_auto'       => $this->gateway->db_info['allow_auto_validate'],
	...
	function edit_method_complete()
	{
		...
		$newbie =  array (
						   ...
						   'submethod_active'   => $this->ipsclass->input['submethod_active'],
						   'submethod_sid'	    => $this->ipsclass->input['submethod_sid'],
						   'submethod_is_cc'    => $this->ipsclass->input['submethod_is_css'],
						   'submethod_is_auto'  => $this->ipsclass->input['submethod_is_auto'],
	...
	function save_transaction($type='edit')
	{
		...
		$save['subtrans_old_group']  = $this->ipsclass->input['subtrans_old_group'];
	...
	function send_success_email( $member )
	{
		...
		$this->email->build_message( array(
											...
											'EXPIRES'  => $this->ipsclass->get_date( $row['subtrans_end_date'], 'DATE' ),

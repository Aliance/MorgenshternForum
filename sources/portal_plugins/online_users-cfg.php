...
*
*/
$PORTAL_CONFIG['pc_title'] = 'Пользователи в он-лайн';

/**
* Plug in mini description
*
*/
$PORTAL_CONFIG['pc_desc']  = "Вывод числа пользователей и их имен, находящихся в он-лайн";
...
*/
$PORTAL_CONFIG['pc_exportable_tags']['online_users_show'] = array( 'online_users_show', 'Вывести блок пользователей в он-лайн' );

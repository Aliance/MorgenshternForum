...
*
*/
$PORTAL_CONFIG['pc_title'] = 'Последние темы с форума';

/**
* Plug in mini description
*
*/
$PORTAL_CONFIG['pc_desc']  = "Выводит последние темы с первым сообщением из них";
...
*/
$PORTAL_CONFIG['pc_exportable_tags']['recent_topics_last_x']             = array( 'recent_topics_last_x'            , 'Вывести блок с последними темами из определенных форумов' );
$PORTAL_CONFIG['pc_exportable_tags']['recent_topics_discussions_last_x'] = array( 'recent_topics_discussions_last_x', 'Вывести блок с последними темами из всех форумов'          );

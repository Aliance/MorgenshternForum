...
*
*/
$PORTAL_CONFIG['pc_title'] = 'Календарь форума';

/**
* Plug in mini description
*
*/
$PORTAL_CONFIG['pc_desc']  = "Вывод мини-календаря на текущий месяц";
...
*/
$PORTAL_CONFIG['pc_exportable_tags']['calendar_show_current_month'] = array( 'calendar_show_current_month', 'Вывести блок с календарем на текущий месяц' );

...
class task_item
{
	...
	function run_task()
	{
		...
		$this->class->append_task_log( $this->task, "Удалено: $_attach_count потерянных прикрепленных файлов, $deleted закончившихся подписок на темы и {$topics_deleted} старых меток прочтения тем" );

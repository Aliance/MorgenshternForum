...
<head>
  ...
  <title>Добавление BB-кода</title>
	...
	function Init()
	{
		...
		document.getElementById("_title").innerHTML   += ' &laquo;' + bbcode['title'] + '&raquo;';
	...
	function do_submit()
	{
		...
		var required = {
						  "f_option_text" : "Вы должны ввести опции тега",
						  "f_content_text": "Вы должны ввести содержимое для тега"
					   };
...
<div class="title" id="_title">Тег</div>

<fieldset style="margin-left: 5px;">
<legend><strong>Пример</strong></legend>
...
<fieldset style="margin-left: 5px;">
<legend><strong>Опции тега</strong></legend>
...
<fieldset style="margin-left: 5px;">
<legend><strong>Содержимое тега</trong></legend>
...
<hr />
<button type="button" class='tblbutton' name="ok" onclick="return do_submit();">Добавить</button>

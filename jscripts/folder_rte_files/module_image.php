...
<head>
  <title>Вставка</title>
	...
	function do_submit()
	{
		...
		var required = {
						  "f_src": "Вы обязаны указать местоположение файла с изображением"
					   };
...
<div class="title">Вставить изображение</div>

<form action="" method="get">

<fieldset style="margin-left: 5px;">
<legend>Местоположение изображения</legend>
...
<div id='advanced-options' style='display:none'>
	...
	<table border="0" width='100%' style="padding: 0px; margin: 0px">
	 ...
	 <tr>
	    <td>Рамка:</td>
	    <td><input type="text" name="border" id="f_ad_border" size="4" value="0" title="Рамка" /></td>
	  </tr>
	  <tr>
	    <td>Заголовок:</td>
	    <td><input type="text" name="title" id="f_ad_title" size="20" value="" title="Название" /></td>
	  </tr>
	  <tr>
	    <td>Подпись под картинкой:</td>
	    <td><input type="text" name="fontsize" id="f_ad_alt" size="20" value="" title="ALT" /></td>
	  </tr>
	  </tbody>
	</table>
	</fieldset>

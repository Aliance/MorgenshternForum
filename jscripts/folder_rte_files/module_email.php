...
<head>
  <title>Вставка</title>
	...
	function do_submit()
	{
		...
		var required = {
						  "f_email": "Вы обязаны ввести e-mail адрес",
						  "f_text": "Вы обязаны ввести текст письма"
					   };
...
<div class="title">Вставить e-mail</div>
...
<table border="0" width='100%' style="padding: 0px; margin: 0px">
  <tbody>
  <tr>
    <td><textarea name="email" id="f_email" style='width:100%;height:60px' cols='23' onfocus='this.select()' rows='4'>user@domain.ru</textarea></td>
  </tr>
  </tbody>
</table>
</fieldset>

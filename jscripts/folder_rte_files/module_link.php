...
<head>
  <title>Вставка</title>
	...
	function do_submit()
	{
		...
		var required = {
						  "f_href": "Вы обязаны ввести URL адрес ссылки",
						  "f_text": "Вы обязаны ввести текст ссылки"
					   };
...
<legend>URL адрес ссылки</legend>
...
<div id='advanced-options' style='display:none'>
	...
	<table border="0" width='100%' style="padding: 0px; margin: 0px">
	  ...
	  <tr>
	    <td>Заголовок:</td>
	    <td><input type="text" name="title" id="f_ad_title" size="20" value="" title="Заголовок" /></td>
	  </tr>
	  <tr>
	    <td>Где открывать ссылку:</td>
	    <td><input type="text" name="fontsize" id="f_ad_target" size="20" value="" title="В каком окне открывать" /></td>
	  </tr>
	  </tbody>
	</table>
	</fieldset>

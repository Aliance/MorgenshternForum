...
" . (($this->ipsclass->browser['browser'] == 'ie' AND $this->ipsclass->browser['version'] >= 7.0) ? ("
	<div style='padding:0px 4px 0px 4px' class='bg1'>
") : ("
...
$IPBHTML = "";
//--starthtml--//
$IPBHTML .= "<div id='smiliestable' style='width:150px;text-align:center'>
...
$IPBHTML = "";
//--starthtml--//
$IPBHTML .= "<script type=\"text/javascript\" src='jscripts/ips_attach.js'></script>

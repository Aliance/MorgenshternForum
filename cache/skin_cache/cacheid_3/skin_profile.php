...
/* CACHE FILE: Generated: Wed, 21 Oct 2009 15:38:36 GMT */
...
<div class=\"borderwrap\">
	...
	" . (($this->ipsclass->input['tab'] == 'pending') ? ("
		<form onsubmit='pp_check_form()' action='{$this->ipsclass->base_url}act=profile&amp;CODE=friends_list_popup&amp;do=friends_list_moderation&amp;md5check={$this->ipsclass->md5_check}&amp;tab={$this->ipsclass->input['tab']}' method='POST'>
	") : ("")) . "
	" . ((is_array($friends) and count($friends)) ? ("
		".$this->__foreach_loop__id_4adf2afc7b479($friends,$pages)."
		<!-- BOTTOM MOD OPTIONS -->
		" . (($this->ipsclass->input['tab'] == 'pending') ? ("
...
function __foreach_loop__id_4adf2afc7b479($friends="",$pages="")
{
	$_ips___x_retval = '';
...
<form onsubmit='check_form()' action='{$this->ipsclass->base_url}act=profile&amp;CODE=personal_iframe_comments_save&amp;member_id={$member['id']}&amp;md5check={$this->ipsclass->md5_check}' method='POST'>
	" . ((is_array($comments) and count($comments)) ? ("
		".$this->__foreach_loop__id_4adf2afc7c031($member,$comments,$pages)."
...
function __foreach_loop__id_4adf2afc7c031($member="",$comments="",$pages="")
{
	$_ips___x_retval = '';
...
$IPBHTML .= "<div id='pp-iframe-wrap' class='pp-contentbox-back' style='overflow:auto'>
	" . ((is_array($friends) and count($friends)) ? ("
		".$this->__foreach_loop__id_4adf2afc7c7fe($member,$friends,$pages)."
...
function __foreach_loop__id_4adf2afc7c7fe($member="",$friends="",$pages="")
{
	$_ips___x_retval = '';
...
<tr>
	...
	<!-- LEFT TABLE -->
		<div class=\"borderwrap\" style='padding:1px'>
			...
			" . (($this->ipsclass->vars['pp_allow_member_rate']) ? ("
				<!-- Rating -->
				<div class='pp-header'>{$this->ipsclass->lang['rating']}</div>
			...
			<!-- Personal Statement -->
			<div class='pp-header'>{$this->ipsclass->lang['m_personal_statement']}</div>
			...
			<div class='row1' style='padding:6px; margin-bottom:0px; padding-left:10px'>
				<div id='pp-entry-born-wrap'>
					" . (($member['bday_day'] AND $member['bday_year'] AND $member['_bday_month']) ? ("
						{$this->ipsclass->lang['born_key']} <span id='pp-entry-born-text'>{$member['bday_day']} {$member['_bday_month']} {$member['bday_year']}</span>
					") : ("
			...
			" . ((is_array( $member['custom_fields'] ) AND count( $member['custom_fields'] )) ? ("
				...
				".$this->__foreach_loop__id_4adf2afc7d3b8($tabs,$member,$comments,$friends,$visitors,$default_tab)."
			") : ("")) . "
			<!-- / Custom Fields -->
			
			<!-- Statistics --> 
			<div class='pp-header'>{$this->ipsclass->lang['m_stats_title']}</div>
			<div class='row1' style='padding:6px; margin-bottom:1px; padding-left:10px'>{$this->ipsclass->lang['m_member_since']} {$member['_joined']}</div>
			<div class='row1' style='padding:6px; margin-bottom:1px; padding-left:10px'>{$this->ipsclass->lang['m_profile_views']} {$member['_pp_profile_views']}<span class='pp-tiny-text'>*</span></div>
			...
			" . (($member['_local_time']) ? ("
				<div class='row2' style='padding:6px; margin-bottom:1px; padding-left:10px'>{$this->ipsclass->lang['m_local_time_is']} {$member['_local_time']}</div>
			") : ("")) . "
			<div class='row1' style='padding:6px; margin-bottom:1px; padding-left:10px'>{$member['_posts']} {$this->ipsclass->lang['m_bit_posts']} ({$member['_posts_day']} {$this->ipsclass->lang['posts_per_day']})</div>
			<!-- / Statistics -->
	...
	<!-- MAIN TABLE -->
		<div class='pp-name'>
			...
			<tr>
				...
				<td width='98%' style='padding-left:10px'>
					<h3 style='font-size:20px'>{$member['char_display_name']}</h3>
					<p>{$member['_member_rank_img']}<strong>{$member['g_title']}</strong></p>
				</td>
			</tr>
			</table>
		</div>
		...
		<div class='pp-tabwrap'>
			".$this->__foreach_loop__id_4adf2afc7db86($tabs,$member,$comments,$friends,$visitors,$default_tab)."
	...
	<div class=\"borderwrap\" style='padding:1px'>
		...
		" . ((is_array($visitors) and count($visitors)) ? ("
			".$this->__foreach_loop__id_4adf2afc7e357($tabs,$member,$comments,$friends,$visitors,$default_tab)."
		") : ("
			<div class='post1' style='padding:6px'>
	...
	<div class=\"borderwrap\" style='padding:1px'>
		...
		" . ((is_array($friends) and count($friends)) ? ("
			".$this->__foreach_loop__id_4adf2afc7eb27($tabs,$member,$comments,$friends,$visitors,$default_tab)."
...
function __foreach_loop__id_4adf2afc7d3b8($tabs=array(),$member=array(),$comments="",$friends=array(),$visitors=array(),$default_tab='posts')
{
	$_ips___x_retval = '';
...
function __foreach_loop__id_4adf2afc7db86($tabs=array(),$member=array(),$comments="",$friends=array(),$visitors=array(),$default_tab='posts')
{
	$_ips___x_retval = '';
...
function __foreach_loop__id_4adf2afc7e357($tabs=array(),$member=array(),$comments="",$friends=array(),$visitors=array(),$default_tab='posts')
{
	$_ips___x_retval = '';
		...
		$_ips___x_retval .= "
				<div class='pp-mini-content-entry'>
					...
					<div style='position:absolute;z-index:2;'>
						{$visitor['_pp_gender_image']} <strong><a href='{$this->ipsclass->base_url}showuser={$visitor['id']}'>{$visitor['members_display_name_short']}</a></strong>
					</div>
					<br />
					<br />
...
function __foreach_loop__id_4adf2afc7eb27($tabs=array(),$member=array(),$comments="",$friends=array(),$visitors=array(),$default_tab='posts')
{
	$_ips___x_retval = '';
	...
	foreach( $friends as $friend )
	{
		...
		$_ips___x_retval .= "
				<div class='pp-mini-content-entry'>
					<div class='pp-image-thumb-wrap-floatright'><img src='{$friend['pp_thumb_photo']}' width='{$friend['pp_thumb_width']}' height='{$friend['pp_thumb_height']}' alt='' /></div>
					<div style='position:absolute;z-index:2;'>
						{$friend['_pp_gender_image']} <strong><a href='{$this->ipsclass->base_url}showuser={$friend['id']}'>{$friend['members_display_name']}</a></strong>
					</div>
					<br />
					<div class='pp-tiny-text'>
						{$friend['posts']} {$this->ipsclass->lang['m_bit_posts']}
						<br />{$this->ipsclass->lang['m_bit_active']} {$friend['_last_active']}
					</div>
				</div>
			";
	}
...
$IPBHTML .= "" . ((is_array($comments) and count($comments)) ? ("
	".$this->__foreach_loop__id_4adf2afc7fac8($comments,$member,$new_id,$return_msg)."
") : ("
	<div class='post1' style='padding:6px'>
		<em>{$this->ipsclass->lang['m_no_comments']} {$member['members_display_name']}.</em>
	</div>
...
function __foreach_loop__id_4adf2afc7fac8($comments="",$member=array(),$new_id=0,$return_msg='')
{
	$_ips___x_retval = '';
...
<tr>
     ...
     <td width=\"70%\" class=\"row1\"><a href=\"{$this->ipsclass->base_url}automodule=gallery&amp;cmd=user&amp;user={$info['mid']}\">{$this->ipsclass->lang['click_here']}</a></td>
</tr>
") : ("")) . "
				<tr>
...
/*--------------------------------------------------*/
/*<changed bits>
personal_portal_main,show_profile
</changed bits>*/
/* END OF FILE                                      */
/*--------------------------------------------------*/

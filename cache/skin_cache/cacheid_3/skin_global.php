...
<div class=\"borderwrap\">
	...
	<div id=\"submenu\">
		...
		" . ((($this->ipsclass->member['mgroup'] >= 4 AND $this->ipsclass->member['mgroup'] <= 8 AND $this->ipsclass->member['mgroup'] != 5) OR ($this->ipsclass->member['mgroup'] >= 11 AND $this->ipsclass->member['mgroup'] <= 18 AND $this->ipsclass->member['mgroup'] != 14)) ? ("
			<div class='ipb-top-left-link'><a href=\"http://www.morgenshtern.com/staff/allies/\" style='color: #f00;'>Мониторинг союзников</a></div>
		") : ("")) . "
		<!--IBF.RULES-->
		<!--ipb.leftlinks.end-->
...
//--starthtml--//
$IPBHTML .= "<!--
<div id='adv'><a href='http://www.morgenshtern.com/encyclopedia'>Энциклопедия</a> предметов Бойцовского Клуба теперь и у нас на сайте.</div>
-->
